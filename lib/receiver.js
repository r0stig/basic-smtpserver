...
receiver.prototype.reply = {
	...
	greet: function() {
		...
		self.reply.send.call(this, "250 " + server_host + " powered by Node.js");
	},
	welcome: function() {
		var self = this;
		//console.log(this);
		self.reply.send.call(this, '220 ' + server_host + ' Hello ' + self.socket.remoteAddress);
	},
	error: function(s) {
		var self = this;
	...
	ok: function() {
		var self = this;
		self.reply.send.call(this, "200 OK");
	},
	data: function() {
		var self = this;
